...
def scrape_players_data():
    fileNameToUrlMap = {
        'statsPerGame': 'https://www.basketball-reference.com/leagues/NBA_2020_per_game.html',
        'statsPer36': 'https://www.basketball-reference.com/leagues/NBA_2020_per_minute.html',
        'statsTotal': 'https://www.basketball-reference.com/leagues/NBA_2020_totals.html'
    }


    for fileName in fileNameToUrlMap:
